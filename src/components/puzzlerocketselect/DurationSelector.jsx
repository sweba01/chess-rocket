    ...
    <div className="w-full flex flex-col gap-4 sm:gap-[24px]">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0">
          ...
          <button
            onClick={onHowToPlay}
            className="flex items-center gap-[8px] hover:opacity-70 transition-opacity self-start sm:self-auto"
          >
        ...
        <div className="grid grid-cols-2 sm:flex sm:items-center gap-2 sm:gap-[14px]">
